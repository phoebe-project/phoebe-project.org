  ...
  render() {
    return (
      <div>
        ...
        <Content>
          <div>
            <p>All PHOEBE repositories are hosted on the <Link to="https://github.com/phoebe-project">phoebe-project GitHub page</Link>.  Below we list the major repositories under development by the <Link to="/development-team">PHOEBE development team</Link>.</p>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-md-10">
              <SourceEntry githubLink="https://github.com/phoebe-project/phoebe2" title="PHOEBE 2">Source-code for all <Link to="/releases">PHOEBE 2.x releases</Link></SourceEntry>
              <SourceEntry githubLink="https://github.com/phoebe-project/phoebe2-ui" title="PHOEBE 2 UI">Source-code for the <Link to="/clients">desktop and web UI clients</Link> built on ReactJS and Electron</SourceEntry>
              <SourceEntry githubLink="https://github.com/phoebe-project/phoebe2-docs" title="PHOEBE 2 Documentation">Jupyter notebooks and markdown sources for PHOEBE 2 tutorials, examples, and documentation.  These are also rendered and available via the <Link to="/docs">documentation section on this website</Link>.</SourceEntry>
              <SourceEntry githubLink="https://github.com/phoebe-project/phoebe2-tables" title="PHOEBE 2 Tables">Atmosphere and passband tables used within PHOEBE 2.0.x and 2.1.x.  These are downloaded automatically by PHOEBE 2 when requested.  For tables for PHOEBE 2.2+, see <Link to="/tables">tables.phoebe-project.org</Link></SourceEntry>
            </div>
          </div>
        ...
        <Content dark={1}>
          ...
          <div className="row">
            ...
            <div className="col-md-10">
              <SourceEntry githubLink="https://github.com/phoebe-project/phoebe1" title="PHOEBE 1">Source-code for all <Link to="/1.0">PHOEBE legacy (0.x and 1.x) releases</Link></SourceEntry>
        ...
        <Content>
          ...
          <SourceEntry githubLink="https://github.com/phoebe-project/phoebe2-workshop" title="PHOEBE Workshop Materials">Jupyter notebooks and links to talks/videos for <Link to="/workshops">PHOEBE Workshops</Link>.</SourceEntry>
          <SourceEntry githubLink="https://github.com/phoebe-project/phoebe-project.org" title="phoebe-project.org">Source-code for this website, written in ReactJS.</SourceEntry>
          <SourceEntry githubLink="https://github.com/phoebe-project/tables.phoebe-project.org" title="tables.phoebe-project.org">Source-code for PHOEBE tables served by <Link to="/tables">tables.phoebe-project.org</Link></SourceEntry>
