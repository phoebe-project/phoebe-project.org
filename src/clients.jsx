      ...
      <div>
        ...
        <Content dark={false} preventScrollTop={this.props.location.hash}>
          ...
          <div className="row">
            ...
            <p>
              Additionally, you can launch the <Link to="#desktop">desktop</Link> client in a blocking or non-blocking mode via <Link to="/docs/latest/api/phoebe.parameters.ParameterSet.ui"><code>PS.ui()</code></Link>.  In Python this will popup a new window and in Jupyter this will include an inline version of the <Link to="#desktop">desktop</Link> client (see <Link to="/docs/latest/tutorials/ui_jupyter.ipynb">launching the UI from Jupyter</Link>).
            </p>
            <p>
          ...
          <div className="row" style={{textAlign: "center", paddingTop: "50px", paddingBottom: "50px"}}>
            <Button level="primary" style={{lineHeight: "2.5em", fontSize: "16px"}} to={"/install"} icon="fa fa-fw fa-download" title={"Install Python Client with PHOEBE"}/>
          </div>
        ...
        <Content dark={true} preventScrollTop={this.props.location.hash}>
          ...
          <div className="row" style={{textAlign: "center", paddingTop: "50px", paddingBottom: "50px"}}>
            <Button level="primary-invert" style={{lineHeight: "2.5em", fontSize: "16px"}} to={"/install"} icon="fa fa-fw fa-download" title={"Install phoebe-server with PHOEBE"}/>
          </div>
